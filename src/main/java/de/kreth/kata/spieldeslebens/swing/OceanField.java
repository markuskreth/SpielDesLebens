...
class OceanField extends JPanel {
  ...
  private static final BufferedImage FISCH;

  private static final BufferedImage SHARK;
  static {
    try {
  ...
  private void paintIcon(Graphics2D g2d) {
    ...
    switch (icon) {
      ...
      case FISH:
        scaledInstance =
            FISCH.getScaledInstance(getWidth(), getHeight(), BufferedImage.SCALE_SMOOTH);
      ...
      case SHARK:
        scaledInstance =
            SHARK.getScaledInstance(getWidth(), getHeight(), BufferedImage.SCALE_SMOOTH);
        g2d.drawImage(scaledInstance, 1, 1, this);
        break;
      default:
        break;
